...
const Confirmation = () =>{
  ...
  return(
    <section ref={bannerRef} className="LL-Confirmations-Page">
      { currentPage === '/confirmation' ?
        <>
      <header className="LL-Confirmations-Title">Reservation confirmed!</header>
      ...
      <p className="LL-Confirmations">Thank you for choosing the Little Lemon!</p>
        ...
        :
        <>
        <header className="LL-Confirmations-Title">Reservation cancelled!</header>
